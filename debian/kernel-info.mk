...
KERNEL_CONFIG_EXTRA_FRAGMENTS = vayu-droidian.config vayu-boot.config vayu-lxc.config vayu-network.config vayu-kvm.config vayu-container.config vayu-lto-disable.config
