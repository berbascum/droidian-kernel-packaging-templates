...
KERNEL_BOOTIMAGE_CMDLINE = androidboot.hardware=qcom androidboot.console=ttyMSM0 androidboot.memcg=1 lpm_levels.sleep_disabled=1  msm_rtb.filter=0x237 service_locator.enable=1 swiotlb=2048 loop.max_part=7 androidboot.usbcontroller=a600000.dwc3 console=tty0 console=ttyMSM0,115200n8 systemd.unified_cgroup_hierarchy=1 buildvariant=user luks.cust.dev=/dev/mmcblk0p4 droidian.lvm.noresize cgroup_enable=cpu cgroup_enable=cpuset
# Unnedeed? video=vfb:640x400,bpp=32,memsize=3072000
